...
window.onload = function(){
	//declaramos variable global para el conteo de fallos
	var num_fallos = 0;
...
function busca_letra(letra_pulsada,palabra_aleatoria,num_fallos){
   ...
   letra_coincide(array_control,letra_pulsada,palabra_aleatoria);
}

/*
 * comprobamos si alguna letra de la palabra coincide con la que hemos pulsado
 */ 
function letra_coincide(array_control,letra_pulsada,palabra_aleatoria){
   ...
   if(devuelve == 1){
       ...
       dibuja_ahorcado(num_fallos,palabra_aleatoria);
   }
 ...
 */
function dibuja_ahorcado(num_fallos,palabra_aleatoria){
   ...
   if(num_fallos < 8){
       ...
       alert("Lo sentimos, has perdido. La palabra era:"+palabra_aleatoria);
