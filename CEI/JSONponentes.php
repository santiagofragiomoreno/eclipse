...
$peticion = curl_init("http://imove.ws/ws/api/ponentes.json");
//configuramos curl
...
if($conexion->connect_error){
    ...
    for($i=0;$i<count($resultado);$i++){
        ...
        $consulta = "INSERT INTO ponentes (nombre,posicion,bio) VALUES ('".addslashes($resultado[$i]['ponente']['nombre'])."','".addslashes($resultado[$i]['ponente']['posicion'])."','".addslashes($resultado[$i]['ponente']['bio'])."')";
