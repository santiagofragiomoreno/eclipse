...
$query_comparacionproducto = sprintf("SELECT codigo, nombre, peso_producto FROM listado_productos WHERE codigo = %s", GetSQLValueString($colname_comparacionproducto, "text"));
...
if($totalRows_comparacionproducto == 0){
	 ...
	 echo $l;
             ...
             $sql = "INSERT INTO productos (peso_actual, codigo,nombre)
             VALUES ($peso, $codigo, )";
